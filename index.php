...
<head>
  <title>Sample Project By Nirob!</title>
  <meta charset="utf-8">
      ...
      <tbody>
        <?php foreach ($lists as $index=> $list) {   ?>
          <tr>
            ...
            <td><?= $list->title; ?></td>
            <td>
              <?php $text = preg_replace("/\r|\n/", "", $list->body); ?>
              <button class="btn btn-info" onclick="showDetails('<?=$text?>')">
                Details
              </button>
            </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Information Details</h5>
